...
export function OuiButtonGroupSelect() {
  ...
  const [currency, setCurrency] = React.useState<Rac.Key>("$");
...
export default function RouteComponent() {
  return (
    <SideBySidePage
      title="Button Group"
      sourceHref="https://github.com/mw10013/oui/blob/main/app/routes/side-by-side.button-group.tsx"
    >
      <SideBySideSection
        title="Demo"
        shadcn={<ButtonGroupDemo />}
        oui={<OuiButtonGroupDemo />}
      />
      <SideBySideSection
        title="Orientation"
        shadcn={<ButtonGroupOrientation />}
        oui={<OuiButtonGroupOrientation />}
      />
      <SideBySideSection
        title="Size"
        shadcn={<ButtonGroupSize />}
        oui={<OuiButtonGroupSize />}
      />
      <SideBySideSection
        title="Nested"
        shadcn={<ButtonGroupNested />}
        oui={<OuiButtonGroupNested />}
      />
      <SideBySideSection
        title="Separator"
        shadcn={<ButtonGroupSeparatorDemo />}
        oui={<OuiButtonGroupSeparatorDemo />}
      />
      <SideBySideSection
        title="Split"
        shadcn={<ButtonGroupSplit />}
        oui={<OuiButtonGroupSplit />}
      />
      <SideBySideSection
        title="Input"
        shadcn={<ButtonGroupInput />}
        oui={<OuiButtonGroupInput />}
      />
      <SideBySideSection
        title="Input Group"
        shadcn={<ButtonGroupInputGroup />}
        oui={<OuiButtonGroupInputGroup />}
      />
      <SideBySideSection
        title="Dropdown"
        shadcn={<ButtonGroupDropdown />}
        oui={<OuiButtonGroupDropdown />}
      />
      <SideBySideSection
        title="Select"
        shadcn={<ButtonGroupSelect />}
        oui={<OuiButtonGroupSelect />}
      />
    </SideBySidePage>
  );
}
