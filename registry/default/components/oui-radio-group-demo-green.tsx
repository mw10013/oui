...
export default function Component() {
  return (
    <FieldGroup>
      ...
      >
        {plans.map((plan) => (
          <Radio value={plan.id} key={plan.id}>
            <FieldContent>
      ...
      >
        {plans.map((plan) => (
          <Radio
            ...
            key={plan.id}
            className={twJoin(
              "data-selected:border-green-600 data-selected:bg-green-50 dark:data-selected:border-green-900 dark:data-selected:bg-green-950",
